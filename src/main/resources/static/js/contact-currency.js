// Контакт валютаси ҳужжат валютасини белгилайди (QBO ҚАТЪИЙ, Arbitr-087,
...
//   курс prefill (Arbitr-029), курс майдони кўриниши (Arbitr-088).
...
(function () {
    function wire(contactField) {
        ...
        // ёзилмайди.
        //
        // Arbitr-157: бошланғич apply'ни ишончли чақириш. Бу оддий скрипт
    ...
    // Arbitr-162 (превентив): HTMX partial билан юкланган формада ҳам
