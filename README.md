...
3. [Comparative research: what we studied](#3-comparative-research-what-we-studied)
4. [Accounting standards (IFRS / IAS)](#4-accounting-standards-ifrs--ias)
5. [Adapting to Uzbekistan](#5-adapting-to-uzbekistan)
6. [Architecture](#6-architecture)
7. [The iron rules](#7-the-iron-rules)
...
## 3. Comparative research: what we studied
...
### 3.1 QuickBooks Online - validating the domain model
...
## 4. Accounting standards (IFRS / IAS)
