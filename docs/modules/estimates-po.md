...
Иккита non-posting ҳужжат (Arbitr-017 2-босқич, фойдаланувчи
...
(Contact.currency), ҳужжатда ўзгартирилмайди (QBO қатъий, Arbitr-087,
...
- BR-EST-004 / BR-PO-004: ҳужжат валютаси контакт валютасига мос
  ...
  Arbitr-087) - server валютани контактдан ЎЗИ олади.
