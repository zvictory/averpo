...
Ҳолат: **ТАСДИҚЛАНГАН (фойдаланувчи)**. Бу ҳужжат UI
йўналишининг ягона манбаси; аввалги ui-lib йўналиши бекор қилинган.

## Қарор ва сабаб

Фойдаланувчи қарори: **тайёр, QA'дан ўтган
...
| Қатлам | Танлов | Изоҳ |
|---|---|---|
| CSS | **Tailwind CSS 4.3+** (жорий барқарор версия 4.3.2) | standalone CLI (Node шарт эмас), CSS-first конфиг (`@theme`) |
...
мос» тамойили - фойдаланувчи); ижро пайтида Context7
...
фойдаланувчи: Аралашда панел оч; тўлиқ Тўқда тўқ). Танлов user-profile попапида (3 ҳолатли
...
танлови, конфигуратор URL'и билан тасдиқланган).
...
**Қидирув - command-palette (фойдаланувчи)**: sidebar'да
...
success/яшил вариант -), dark toggle user-profile
попапида.
