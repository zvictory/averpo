...
## Expense экрани + PaymentMethod ✅ (Arbitr-033)
...
## UI етуклик пакети ✅ (/08: Arbitr-023/024/025/029/031/035/036)
...
login lockout (5 хато → 15 дақиқа), createdBy аудит майдони. Профиль ✅ (Arbitr-101, changeset 057+066): /profile саҳифаси
...
4в. **Statement** ✅ (Жасур, print қатлами билан -
 Arbitr-040 негизи).
4г. **«+ Янги» мега-меню** ✅ (Arbitr-038): QBO Create
 панели услубидаги кенг кўп устунли панел - қурилган, deploy 1 да
 жонли серверда.
4д. **Глобал қидирув** ✅ (Arbitr-039, кейин 061 да
