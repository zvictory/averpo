...
## Эталон: QuickBooks Online

Дизайн қарорларида QuickBooks Online мажбурий эталон: счётлар режаси
тузилмаси (Classification → AccountType → DetailType), home currency,
ҳужжат оқимлари, ҳисоботлар - ҳаммаси QBO'га қараб лойиҳаланади.
Икки ечим орасида иккиланилса - аввал `docs/qbo-reference/` (расмий
Finance.xsd + entities.md солиштирмаси) текширилади, веб-саҳифа эмас.

**Атайлаб фарқ ИККИТА:**
1. **Кўп-омборли инвентар** (QBO'да омбор тушунчаси йўқ); landed cost
   ва Unit каталоги шу кенгайтманинг таркибий қисмлари.
2. **Payroll Lite** (QBO ядросида payroll йўқ - алоҳида маҳсулот).

QBO'да йўқ нарса шу икки фарққа тегишли бўлмаса - қўшилмайди.
