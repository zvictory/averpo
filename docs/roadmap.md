...
## 2-босқич - Ledger ядроси ✅ (2026-07-05)
...
- Opening balance + CoA balance устуни (2026-07-06)
Натижа: тизимда қўлда бухгалтерия юритса бўлади.

## 2.5-босқич - Пойдевор + QBO UI пакети ✅ (2026-07-06, барча банд бажарилган)
...
## 3-босқич - Contacts + Items экранлари ✅ (2026-07-06, task #28)
Customer/Vendor CRUD, Item (товар/хизмат), ItemCategory, Unit экранлари -
янги UI пакет намунасида.

## 3.5-босқич - Бухгалтерия асослари ✅ (2026-07-06, task #29-31)
- DocumentSequence: умумий ҳужжат рақамлаш (INV/BILL/PAY/JE) ✅ (2026-07-06,
  docs/modules/document-sequence.md; JE рақами document_sequence'га кўчди)
- Closing date lock (QBO услуби, эски fiscal_period соддалаштирилган)
  ✅ (2026-07-06, docs/modules/closing-date.md, BR-LED-020)
- Contact кенгайтириш: манзиллар, шахслар, банк, credit limit, ИНН
  ✅ (2026-07-06, contact.md «Кенгайтма», BR-CON-005..010, changeset 016)

## 4-босқич - Multi-currency ✅ (2026-07-06)
...
## 4.5-босқич - Detail type номларини QBO расмийсига тузатиш ✅ (2026-07-06)
...
## 5-босқич - Inventory (task #32) ✅ (2026-07-06)
...
## 6-босқич - Purchases (task #33 нинг Bill қисми) ✅ (2026-07-06)
...
## 7-босқич - Sales (task #33 нинг Invoice қисми) ✅ (2026-07-06)
...
## 8-босқич - Banking ✅ (2026-07-06, task #34)
BankAccount, транзакциялар, конверсия, reconciliation
(bank_statement + line, old-erp-ideas.md §5).
✅ (2026-07-06) Бажарилди: docs/modules/banking.md - changeset 022,
...
## 9-босқич - Reports ✅ (2026-07-06)
Balance Sheet, P&L, inventory valuation, dashboard.
✅ (2026-07-06) Бажарилди: docs/modules/reports.md - changeset 024
...
(Komil-004 2-босқичи: asOf'гача post қилинган ҳужжатлар минус
asOf'гача allocation'лар; ҳозирча aging фақат жорий санага -
BR-RPT-001). Cash basis toggle - «Кейинги босқичлар»да.

## UoM босқичи - Бирлик гуруҳлари ва конверсия (task #37) ✅ (2026-07-07)
...
## PriceList босқичи - Нарх рўйхатлари (task #38) ✅ (2026-07-07)
...
DiscountRule (фоиз/фикс чегирма) АТАЙЛАБ кейинги босқичга (2026-07-07).

## Tax босқичи - ҚҚС каталоги ва ҳужжат солиғи (task #35) ✅ (2026-07-07)
...
## AuditLog босқичи - аудит журнали ✅ (2026-07-07)
...
## Expense экрани + PaymentMethod ✅ (2026-07-07, Arbitr-033)
...
## UI етуклик пакети ✅ (2026-07-07/08: Arbitr-023/024/025/029/031/035/036)
...
(Arbitr-036): cash flow, охирги 30 кун тўловлари, тез амаллар,
inventory карталари + drill-down (тафсилот: reports.md Dashboard).

## Class tracking босқичи - Йўналиш кесими ✅ (2026-07-08)
...
## Хавфсизлик ✅
Spring Security + form login + CSRF. **Роллар ✅ 2026-07-11
(Arbitr-092, changeset 052): 8 роль (SUPER_ADMIN, DIRECTOR_ADMIN,
...
User management ✅ (2026-07-07): docs/modules/user-management.md -
...
login lockout (5 хато → 15 дақиқа), createdBy аудит майдони. Профиль ✅
2026-07-14 (Arbitr-101, changeset 057+066): /profile саҳифаси
...
Unrealized курс фарқи (Komil-006), multi-tenant, BS/P&L cash basis
toggle ва таққослаш устунлари (QBO customize), DiscountRule
(Arbitr-019 огоҳлантириши: QBO Online'да йўқ - кўлам алоҳида
келишилади), AutoApplyCredit преференцияси (Otabek-009: QBO default
кредитни автоматик қўллайди - бизда онгли равишда фақат қўлда,
entities.md §8), Transfer'га ClassRef + Balance Sheet by Class
(Otabek-008: онгли фарқ ҳужжатланди - зарурат чиқса). Service хатолари i18n энди бу рўйхатда ЭМАС - 1.0
production пасига кирди (Xorazmiy-001, NAVBAT 19-банд).
QBO parity қолдиқлари (Arbitr-017/019, унутилмаслиги учун рўйхатда):
...
~~Employee~~ - 1.0 кўламига кўчди (2026-07-08, «1.0 МАРРАСИ» 4а-4в).
РАД этилганлар (2026-07-07, фойдаланувчи қарори - қайта таклиф
қилинмайди, SABOQLAR'да): чек, credit card оқимлари (Otabek-001,
CreditCardPayment), UF/bank Deposit боғланган оқими (Arbitr-018).

## 1.0 МАРРАСИ (таъриф - 2026-07-08, фойдаланувчи режаси асосида)

1.0 = қуйидагилар ТУГАГАНда (бошқа ҳеч нарса 1.0'ни тўсмайди):

1. **А-рўйхат (QBO кўлам якуни)**: Class tracking (Arbitr-015,
   docs/modules/class-tracking.md) ✅ 2026-07-08, Returns -
   CreditMemo/VendorCredit/RefundReceipt (Arbitr-017,
   docs/modules/returns.md) ✅ 2026-07-08, Estimate/PurchaseOrder
   (docs/modules/estimates-po.md) ✅ 2026-07-08, IFRS ҳисобот
   тақдимоти (Arbitr-026) ✅ 2026-07-08.
   А-РЎЙХАТ ТЎЛИҚ ЁПИЛДИ.
2. **Якуний катта review раунди**: 2026-07-07/08 да қурилган барча
   янги ишлар (Expense, drawer/CoA, dashboard, Class, IFRS, Returns,
   Est/PO) устидан тўлиқ кўрик + триаж + тузатишлар.
3. **Production паси**: Xorazmiy-001 (BR хабарлари i18n),
   Beruniy-perf1 + Beruniy-018 (пагинация/overfetch master),
   Arbitr-027 (rollback аудити - шу пасда триггери отилади).
   Eldor-001 (DB парол fail-fast) ✅ 2026-07-08.
4. **Attachments (Arbitr-013, docs/modules/attachments.md)**
   ✅ 2026-07-08 (Жасур, changeset 042;
   қамров кенгайиши - қолган кўришлар + map - Arbitr-048 фикс
   тўлқинида).
4а. **Payroll Lite + аванс** (фойдаланувчи буюрди 2026-07-08 -
   ...
   docs/modules/payroll.md. ✅ 2026-07-08: Employee/ставкалар (23а),
   PayrollRun (23б, PAYR- рақам), PayrollPayment + ведомость (23в) -
   учала туртки ТАСДИҚ. Ведомость GL асосига кўчиши - Arbitr-047
   фикс тўлқинида.
4б. **SalesReceipt** ✅ 2026-07-08 (Исломбек, changeset 046, SR-).
4в. **Statement** ✅ 2026-07-08 (Жасур, print қатлами билан -
   Arbitr-040 негизи).
4г. **«+ Янги» мега-меню** ✅ 2026-07-08 (Arbitr-038): QBO Create
   панели услубидаги кенг кўп устунли панел - қурилган, deploy 1 да
   жонли серверда.
4д. **Глобал қидирув** ✅ 2026-07-09 (Arbitr-039, кейин 061 да
...
4ж. **Setup оқими ва фойдаланувчи қулайликлари** ✅ 2026-07-09/10:
   биринчи кириш redirect (Arbitr-056), Excel бошланғич import
...
4е. **QBO parity тўртлиги** ✱ (2026-07-08, фойдаланувчи: rebrand'дан
   ОЛДИН): Arbitr-040 ҳужжат чоп этиш/PDF/email (Statement print
   нақшидан кенгаяди), Arbitr-041 Recurring transactions, Arbitr-042
   банк CSV импорти + match, Arbitr-043 ҚҚС давр ҳисоботи. NAVBAT
   29-32 бандлар (D/E-тўлқинлар); 040/041/042 spec-аввал.
5. **Averpo номига тўлиқ ўтиш ✅ 2026-07-16** (расмий ном
   averpo.com - фойдаланувчи 2026-07-15): пакет com.averpo.erp,
   ...
   сервер миграцияси ва DEPLOY 5 (app.averpo.com + averpo.com) -
   2026-07-15. Changeset author'лар averpo (фойдаланувчи қарори
   2026-07-16).
6. **1.0 release**: build версияси 1.0.0 + roadmap/README белгиси +
   git tag v1.0.0 (фойдаланувчи қўяди).

Backlog сиёсати (1.0'га КИРМАЙДИ): тригерли ёзувлар (Arbitr-002/004,
Beruniy-013, Komil-007) фақат триггер отилганда - махсус вақт
ажратилмайди; Beruniy-backlog4 МУЗЛАТИЛГАН; Komil-006 (unrealized FX) -
