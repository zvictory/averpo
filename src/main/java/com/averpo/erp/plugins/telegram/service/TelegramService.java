 ...
 *
 * <p><b>Токен сири</b>: базада ШИФРЛАНГАН ({@link SecretCrypto}, лойиҳа
 * қарори); очиқ қиймат фақат Bot API чақируви учун
...
public class TelegramService {
     ...
     * инглизча ёки русча гапириб қоларди (тест тутган ҳодиса).
     ...
     *
     * <p><b>deleteWebhook транзакция ИЧИДА</b> (қоида: мураккаблашса
     * ичда, try/catch+WARN билан асослансин):
     ...
     * билишимиз шарт).
     *
     * <p>ТРАНЗАКЦИЯСИЗ: {@code registerWebhook} тармоқ
