...
| currency | ManyToOne Currency | Ҳужжат валютаси (қоида №11). Контактдан олинади (Contact.currency), ҳужжатда ўзгартирилмайди - QBO қатъий, DEC-087 (BR-BILL-013); тафсилот multi-currency.md |
...
- **Bill reverse**: аввал receipt'ларга ФАОЛ landed cost тақсимоти
  йўқлиги текширилади (BR-BILL-012, PERF-005 - акс ҳолда юкланган
  ...
  ОХИРГИ ҳаракат бўлиши шарт (BR-INV-010, PERF-003 - AVCO ва FIFO
...
| BR-BILL-013 | Bill валютаси таъминотчи валютасига мос бўлиши шарт (Contact.currency, null = home; QBO қатъий, DEC-087) - server валютани контактдан ЎЗИ олади |
...
- FIFO: R = receipt яратган layer'нинг remaining_qty; layer unit_cost
  ...
  (PERF-004: бутун қолдиқни олиш сотилган receipt харажатини
...
LOG-001 - qty шартини оралиқ чиқим + янги кирим алдаб ўтар эди),
...
Bill reverse билан боғлиқлик (BR-BILL-012, PERF-005): receipt'ига
