 ...
 *
 * <p><b>Стандарт - IAS 21 «Валюта курслари ўзгаришининг таъсири»</b>:
 * ҳар операция битим санасидаги курс бўйича функционал (home) валютага
 * ўгирилиб ёзилади. Айнан шунинг учун бу ерда УЧТА майдон сақланади:
 * ҳужжат валютасидаги сумма, home валютадаги эквивалент ва ишлатилган
 * курс - учови бирга турса, тарихий ёзув кейин курс ўзгарса ҳам қайта
 * ҳисобланмайди ва аудитда исботланади.
 *
 * <p><b>Аниқлик</b>: пул NUMERIC(19,4), курс NUMERIC(24,12) - тескари
 * курслар (1 UZS = 0.000082690073 USD) ҳам саккиз маъноли рақам
 * сақлаши учун. Xero солиштируви: у курсни 18.6 аниқликда сақлайди ва
 * интеграторларни курс ЙЎНАЛИШИ (foreign per base) бўйича алоҳида
 * огоҳлантиради - шунинг учун бизда йўналиш майдон изоҳида қатъий
 * ёзилган: {@code 1 currency = rate home}.
 */
@Embeddable
@Getter
public class Money {
