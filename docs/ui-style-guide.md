...
Ҳолат: (DEC-009). Манба - мавжуд JTE экранларнинг ўзи:
...
Ҳамма `<table>` Penguin услубида (DEC-120 свипи; реф:
...
Ҳамма форма контроли Penguin utility йиғимида (DEC-121 свипи;
...
Қидирувли танлагичлар (DEC-123 свипи; реф: `docs/penguin-refs/
...
- **Интероп контракти**: танланган li'нинг data-* атрибутлари value
  ...
  комбобокс кўринишни ўзи синхронлайди. Ташқи филтрлар (DEC-070
...
- Форма саҳифаларида ҳам ФАҚАТ `@template.shared.alert(...)` -
  эски inline яшил/қизил `<p>` хабарлар DEC-121 свипида alert'га
  ўтган.
...
ёзилади (DEC-118 свипи: `.btn` оиласи ўчирилган; реф:
...
Бу оилалар Penguin utility йиғимларида (DEC-119 свипи; эски
...
- **Сарлавҳа тэглари канони (DEC-122)** - preflight ўлчам бермайди,
...
- **Боди/контент зонаси (DEC-122; оқ канвас - DEC-123 қўшимча,
...
| `Fmt.rate(rate)` | Валюта курси: >= 1 → қатъий 2 хона; < 1 → макс 8 хона, trailing нолсиз (DEC-135) | `12 090.45`, `0.00008334` | `Fmt.java:138` |
...
Жадвал атомиклари (.r/.c/.num) DEC-120 свипида Tailwind
...
йиғимларида ёзилади (DEC-121 қарори, 2-бўлим канони; эски
.form-control/.fgrid режалари бекор - Тугмалар (118) услуби танланди).

## Четлашишлар (DEC-007/008 номзодлари - бу ерда ФАҚАТ қайд)

1. ~~Такрор локал zebra~~ - DEC-120 свипида ҳал: zebra фақат
