...
-- DEC-076 (DB-002): асосий ҳужжатларда курс DB даражасида
...
-- DEC-076 (DB-003): sales_receipt «invoice кўзгуси» - unit_price
...
-- DEC-076 (LOG-014б): payroll.md:93 специ gross'га «numeric(19,4)
