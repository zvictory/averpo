...
public class BankTransactionController {
     ...
     * (DEC-068): давр/статус/контакт/матн (ref_no ҳам қидирилади),
    ...
    public String createForm(@RequestParam(required = false) String type, Model model) {
        // DEC-033: Чиқим энди алоҳида /expenses экранида - эски
    ...
    public String create(@ModelAttribute BankTransactionForm form,
        ...
        try {
            ...
            BankTransaction txn = switch (type) {
                ...
                // Чиқим алоҳида /expenses экранида (DEC-033) - transfer
                ...
                // Ўтказма алоҳида /transfers экранида (DEC-022) - бу эски
    ...
    public String view(@PathVariable UUID id, Model model) {
        ...
        // (UI-003); валютасиз счёт = home валюта
    ...
    private void fillFormModel(Model model, BankTransactionForm form,
        ...
        // OPT-009: контактлар ҳам бир марта - аввал fillFormModel ва
     ...
     * id'лар byIds/IN сўровда (DEC-105б, AUD-003 §1); нофаоллар
