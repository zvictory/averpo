 ...
 * стандарти, DEC-011): {@code 12 600.50}.
 */
public final class Fmt {

    /**
     * Пул кўрсатиш аниқлиги: қатъий 2 хона (HALF_UP) - QBO стандарти
     * (DEC-011 қарори). Сақланадиган қийматлар тўлиқ аниқликда
    ...
    /**
     * Курс >= 1 бўлганда кўрсатишдаги қатъий хоналар сони (DEC-135) -
    ...
    /**
     * Курс < 1 бўлганда кўрсатишдаги энг кўп ўнлик хона (DEC-135):
    ...
    /**
     * Валюта курси (DEC-135, фойдаланувчи қоидаси): қиймат >= 1 -
    ...
    /**
     * Курс блоки компонентининг (rateBlock.jte, DEC-097) КИРИТИШ
     ...
     * қиймати {@link #rate(BigDecimal)} кўринишида (DEC-135) - хом
     ...
     * атайлаб ишлатилмайди (DEC-011). Каср қисми гуруҳланмайди -
