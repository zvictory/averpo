...
| currency | varchar(3) nullable | Контакт валютаси (QBO multicurrency услуби). Бўш - home currency. Қулф: POSTED ҳужжат бор бўлса ўзгартирилмайди - BR-CON-012 (Arbitr-087, multi-currency.md) |
