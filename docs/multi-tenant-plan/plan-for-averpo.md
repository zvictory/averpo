...
Сана: 2026-07-20. Ҳолат: ЛОЙИҲА (фойдаланувчи тасдиғи кутилади).
...
## 3. Реал инвентаризация (2026-07-20 ҳолати)
...
- **D8. RLS FORCE + DB роль ажратиш**: application энди ЭГАСИ БЎЛМАГАН
  ...
  қилинади). Policy: `USING (tenant_id = current_setting(
  'app.current_tenant')::uuid) WITH CHECK (шу)`. Wiring: DataSource
