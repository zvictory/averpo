...
эмас (DEC-022, фойдаланувчи скриншот солиштируви).
...
## Қатъий қарорлар (фойдаланувчи билан келишилган)
...
- **КЎЛАМ**: транзфер ҳар қандай Balance Sheet счёти орасида - фаол,
  ...
  (QBO-001 рад) - автоматик четда.
- **ИСТИСНО - тизим назорат счётлари** (IFRS-008, BR-TXF-002): қуйидаги
  ...
  (23а payroll'да қўшилган - AUD-019 янгилови),
...
- **CLASS ҚЎШИЛМАЙДИ** (онгли фарқ - QBO-008, зарурат чиқса).
- **RECURRING ва ATTACHMENTS йўқ** (recurring - алоҳида кейинги иш;
  attachments - DEC-013 backlog).
...
from/to сумма+курс майдонлари аллақачон бор - DEC-012). «bank»
...
- **BR-TXF-002** (IFRS-008): манба ва манзил счёти
...
- Форма: «Манбадан» (tree-select, ёнида жонли Balance), «Манзилга»
  ...
  сумма авто, қўлда устун) - DEC-012 UI'си қайта ишлатилади.
- Tree-select: DEC-014 shared/accountOptions - манба ҳар қандай BS
  счёти (disableNonPostable=true, гуруҳ счётлар disabled).
- Рўйхат: /transfers - сана, манба→манзил, сумма, ⋮ (Кўриш/сторно).
  shared/rowMenu (BA-007 P1a).
...
БАЖАРИЛДИ (1-7 банд, DEC-022 done'да). Қуйида давоми.

## Такомиллаштиришлар (фойдаланувчи билан келишилган)
...
- Бу DEC-014'даги «typeahead 2-босқич» - ҚАЙТА ИШЛАТИЛАДИГАН
...
- КУРС ТАРИХИ (append-only, changeset 033): курс энди
