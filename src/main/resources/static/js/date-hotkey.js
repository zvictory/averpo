// DEC-144: сана майдонлари учун QBO услубидаги клавиатура
...
// узатиш бу ерда аниқлик қўшмай мураккаблик қўшарди (DEC-144
...
(function () {
    ...
    document.addEventListener('keydown', function (e) {
        ...
        e.preventDefault();
        t.value = iso(d);
        // Программатик .value ёзуви event чиқармайди (DEC-086
