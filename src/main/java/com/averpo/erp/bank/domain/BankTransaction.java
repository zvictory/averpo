 ...
 *
 * <p><b>Discriminator нақши (NetSuite'дан олинган ғоя)</b>: уч тур
 * битта жадвалда {@code type} устуни билан ажратилади. NetSuite бутун
 * тизимни шу принцип билан қуради - барча ҳужжат тури ягона
 * {@code transaction} жадвалида {@code TYPE} устуни орқали. Биз буни
 * АТАЙЛАБ фақат шу ерда қўлладик, чунки кирим/чиқим/ўтказманинг шакли
 * ва инвариантлари деярли бир хил (банк счёти, сана, сатрлар, жами).
 * Invoice/Bill/Payment каби турлари эса чинакам фарқли - уларни битта
 * жадвалга йиғиш constraint кучини йўқотиб, кенг ва сийрак жадвал
 * берарди (README «Қиёсий тадқиқот»: нимани олдик, нимани олмадик).
 *
 * <p><b>Валюта конверсияси - IAS 21</b>: TRANSFER'да икки счёт валютаси
 * фарқ қилса, юборилган ва келган суммаларнинг home эквиваленти
 * тенг келмайди; фарқ курс фойда/зарар счётига проводка қилинади.
 */
@Entity
