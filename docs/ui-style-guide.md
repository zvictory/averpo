...
Ҳолат: 2026-07-06 (Arbitr-009). Манба - мавжуд JTE экранларнинг ўзи:
...
- **Матн аниқлиги (фойдаланувчи талаби 2026-07-17)**: устун сарлавҳаси
...
| `Fmt.dt(instant, zone)` | UTC вақтни компания минтақасида кўрсатиш | `2026-07-05 21:45` | `Fmt.java:125` |
...
Йўналиш специ: **docs/modules/ui-framework.md (ТАСДИҚЛАНГАН
2026-07-16)** - Tailwind CSS 4.3+ + Penguin UI (компонент
