...
public class CreditMemoForm {
    ...
    public static CreditMemoForm empty(int rows) {
        CreditMemoForm form = new CreditMemoForm();
    ...
    /**
     * Асл invoice'дан prefill (QBO оқими: кредит invoice'дан очилади):
     * сатрлар тўлиқ кўчади, ҚҚС ставка ҚИЙМАТИ ҳам snapshot сифатида -
     * орада каталог ўзгарган бўлса ҳам асл ставкада қайтим.
     */
    public static CreditMemoForm from(Invoice invoice) {
        CreditMemoForm form = new CreditMemoForm();
    ...
    /** Битта форма сатри - CM LineData кўзгуси. */
    @Getter
    @Setter
    @NoArgsConstructor
